...
private:
	size_t blk_seq;
	size_t face_seq;
	size_t pri_start_seq, pri_end_seq;
	size_t sec_start_seq, sec_end_seq;
...
public:
	...
	NMF_BCRange(size_t b, size_t f, size_t s1, size_t e1, size_t s2, size_t e2)
	{
		blk_seq = b;
		face_seq = f;
		pri_start_seq = s1;
	...
	bool range_constains(size_t pri, size_t sec) const
	{
