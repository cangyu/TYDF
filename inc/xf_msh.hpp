...
namespace XF
{
    ...
    public:
        ...
        static const std::string &idx2str(int x)
        {
            static const std::map<int, std::string> Idx2StrMapping{
                    std::pair<int, std::string>(BC::INTERIOR, "interior"),
                    std::pair<int, std::string>(BC::WALL, "wall"),
                    std::pair<int, std::string>(BC::PRESSURE_INLET, "pressure-inlet"),
                    std::pair<int, std::string>(BC::PRESSURE_OUTLET, "pressure-outlet"),
                    std::pair<int, std::string>(BC::SYMMETRY, "symmetry"),
                    std::pair<int, std::string>(BC::PERIODIC_SHADOW, "periodic-shadow"),
                    std::pair<int, std::string>(BC::PRESSURE_FAR_FIELD, "pressure-far-field"),
                    std::pair<int, std::string>(BC::VELOCITY_INLET, "velocity-inlet"),
                    std::pair<int, std::string>(BC::PERIODIC, "periodic"),
                    std::pair<int, std::string>(BC::FAN, "fan"),
                    std::pair<int, std::string>(BC::MASS_FLOW_INLET, "mass-flow-inlet"),
                    std::pair<int, std::string>(BC::INTERFACE, "interface"),
                    std::pair<int, std::string>(BC::PARENT, "parent"),
                    std::pair<int, std::string>(BC::OUTFLOW, "outflow"),
                    std::pair<int, std::string>(BC::AXIS, "axis")
            };
        ...
        static const int str2idx(const std::string &x)
        {
            static const std::map<std::string, int> Str2IdxMapping{
                    std::pair<std::string, int>("interior", BC::INTERIOR),
                    std::pair<std::string, int>("wall", BC::WALL),
                    std::pair<std::string, int>("pressure-inlet", BC::PRESSURE_INLET),
                    std::pair<std::string, int>("inlet-vent", BC::INLET_VENT),
                    std::pair<std::string, int>("intake-fan", BC::INTAKE_FAN),
                    std::pair<std::string, int>("pressure-outlet", BC::PRESSURE_OUTLET),
                    std::pair<std::string, int>("exhaust-fan", BC::EXHAUST_FAN),
                    std::pair<std::string, int>("outlet-vent", BC::OUTLET_VENT),
                    std::pair<std::string, int>("symmetry", BC::SYMMETRY),
                    std::pair<std::string, int>("periodic-shadow", BC::PERIODIC_SHADOW),
                    std::pair<std::string, int>("pressure-far-field", BC::PRESSURE_FAR_FIELD),
                    std::pair<std::string, int>("velocity-inlet", BC::VELOCITY_INLET),
                    std::pair<std::string, int>("periodic", BC::PERIODIC),
                    std::pair<std::string, int>("fan", BC::FAN),
                    std::pair<std::string, int>("porous-jump", BC::POROUS_JUMP),
                    std::pair<std::string, int>("radiator", BC::RADIATOR),
                    std::pair<std::string, int>("mass-flow-inlet", BC::MASS_FLOW_INLET),
                    std::pair<std::string, int>("interface", BC::INTERFACE),
                    std::pair<std::string, int>("parent", BC::PARENT),
                    std::pair<std::string, int>("outflow", BC::OUTFLOW),
                    std::pair<std::string, int>("axis", BC::AXIS)
            };
    ...
    public:
        MSH() : DIM(3), m_totalNodeNum(0), m_totalCellNum(0), m_totalFaceNum(0), m_totalZoneNum(0) {}

        MSH(const std::string &inp) : DIM(3), m_totalNodeNum(0), m_totalCellNum(0), m_totalFaceNum(0), m_totalZoneNum(0)
        {
            readFromFile(inp);
        }
